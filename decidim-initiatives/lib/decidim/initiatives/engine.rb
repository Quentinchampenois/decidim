  ...
  module Initiatives
    ...
    class Engine < ::Rails::Engine
      ...
      initializer "decidim_initiatives.content_blocks" do
        ...
        Decidim.content_blocks.register(:homepage, :answered_initiatives) do |content_block|
          content_block.cell = "decidim/initiatives/content_blocks/answered_initiatives"
          content_block.public_name_key = "decidim.initiatives.content_blocks.answered_initiatives.name"
          content_block.settings_form_cell = "decidim/initiatives/content_blocks/answered_initiatives_settings_form"
